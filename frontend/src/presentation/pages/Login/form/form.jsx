...
import { loginUser } from "../../../../context/functions/usuarios/usuariosFuntion";
...
export const LoginForm = () => {
    ...
    const onSubmit = (data) => loginUser(data)//console.log(data)
        ...
        <section class="py-1- md:py-8 dark:bg-gray-800">
            ...
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <a href="/" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                    <div class="w-20 h-20 p-5 bg-green-600 rounded-full mt-3">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="" class="text-sm font-medium text-green-700 hover:underline dark:text-green-500">Esqueceu sua senha?</a>
                    </div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Não possui uma conta? <Link to={"../registro"}
                        class="font-medium text-green-600 hover:underline dark:text-green-500">Registre-se</Link>
                    </p>
    </form>
